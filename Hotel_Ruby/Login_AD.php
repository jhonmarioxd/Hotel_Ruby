...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/Login_AD.css">
...
<body class="scroll-bar">
    ...
    <main>
        <div class="contenedor__login_register">
            <!--Login-->
            <form action="bd/login_admin.php" method="post" class="formulario__login">
                <h2>Iniciar Sesión Admin</h2>
                <input type="text" placeholder="Admin" name="Usuario_AD">
                <input type="password" placeholder="Contraseña" name="contrasena_AD">
                <button type="submit" name="loguer_AD">Entrar</button>
            </form>
        </div>
    </main>
